class DriveInfo:
	...
	def model_number(self) -> str:
		return self.values.get('Model Number', "N/A")
	...
	@property
	def total_nvm_capacity(self) -> str:
		return self.values.get('Total NVM Capacity', "N/A")
	...
	@property
	def nvme_version(self) -> str:
		return self.values.get('NVMe Version', "N/A")
