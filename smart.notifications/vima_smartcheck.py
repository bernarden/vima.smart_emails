...
def main(arguments):
	...
	email_body_generator.generate(run_list, drive_info, get_drive_name())
...
def read_logs(drive_directory):
	...
	if (len(file_listing) == 0):
		...
		return (extract_attributes(drive_directory + '/' + file_listing[1]), None, extract_attributes(drive_directory + '/' + file_listing[0]))
